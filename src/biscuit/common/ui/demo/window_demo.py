...
def maximizeToggle():
    ...
    if not maximized:
        ...
        windll.user32.SetWindowPos(
            ...
            int(root.winfo_screenheight() - 48),
            SWP_SHOWWINDOW,
        )
        maximized = True
...
title_name = tk.Label(
    title_bar, text=title_window, font="Arial 12", bg=back_ground, fg="white"
)
...
window = tk.Frame(
    root  # , bg="white", highlightthickness=1, highlightbackground=back_ground
)
