...
This is a fork of [Biscuit](https://github.com/tomlin7/biscuit) with a Retro 90s theme. 

![biscuit90s](.github/image.png)

# What's Changed?

- I have gone through the whole codebase and removed the custom theming engine entirely.
- Editor now uses native TTK widgets and styles. What you see is the "clam" theme. It looks similar to good old Windows 95/98.
